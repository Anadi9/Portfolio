...
seoTitle: "Works locally, breaks on Vercel: the 5 usual causes"
description: "Works on localhost, fails on Vercel? Missing env vars, 404s on refresh, case-sensitive imports, the wrong output folder or localhost redirects. Fixes for each."
date: "2026-09-24"
